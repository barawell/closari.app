...
export default function Landing() {
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', color: '#0D0D0D', background: '#fff', overflowX: 'hidden' }}>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(8px)', borderBottom: '1px solid #E5E5E5' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 clamp(16px, 5vw, 24px)', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <nav style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
            <a href="#demo" className="lp-nav-secondary" style={{ color: '#6B7280', textDecoration: 'none', fontSize: 14, padding: '6px 12px', borderRadius: 6 }}>Demo</a>
            <a href="#fitur" className="lp-nav-secondary" style={{ color: '#6B7280', textDecoration: 'none', fontSize: 14, padding: '6px 12px', borderRadius: 6 }}>Fitur</a>
            <Link href="/login" style={{ color: '#6B7280', textDecoration: 'none', fontSize: 14, padding: '6px 12px', borderRadius: 6 }}>Masuk</Link>
            <Link href="/login" style={{ background: '#0D0D0D', color: '#fff', padding: '7px 16px', borderRadius: 7, textDecoration: 'none', fontSize: 14, fontWeight: 500, letterSpacing: '-0.01em', whiteSpace: 'nowrap' }}>Mulai gratis</Link>
          </nav>
        </div>
      </header>

      {/* HERO */}
      <section style={{ maxWidth: 1080, margin: '0 auto', padding: 'clamp(48px, 8vw, 80px) clamp(20px, 5vw, 24px) clamp(40px, 6vw, 64px)', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, border: '1px solid #E5E5E5', borderRadius: 999, padding: '5px 14px 5px 8px', marginBottom: 28, fontSize: 'clamp(12px, 3.2vw, 13px)', color: '#6B7280', maxWidth: '100%' }}>
          <span style={{ background: '#16A34A', color: '#fff', fontSize: 11, fontWeight: 600, padding: '2px 8px', borderRadius: 999, letterSpacing: '0.02em', flexShrink: 0 }}>BARU</span>
          <span style={{ textAlign: 'left' }}>Realtime inbox — pesan masuk otomatis tanpa refresh</span>
        </div>

        <h1 style={{ fontSize: 'clamp(30px, 7.5vw, 56px)', lineHeight: 1.1, fontWeight: 700, letterSpacing: '-0.04em', color: '#0D0D0D', maxWidth: 700, margin: '0 auto 20px' }}>
          Platform WhatsApp Business{' '}
          <span style={{ color: '#16A34A' }}>untuk tim CS modern.</span>
        </h1>

        <p style={{ fontSize: 'clamp(15px, 4.2vw, 17px)', color: '#6B7280', lineHeight: 1.65, maxWidth: 500, margin: '0 auto 36px' }}>
      ...
      {/* LIVE DEMO */}
      <section id="demo" style={{ background: '#F7F7F7', borderTop: '1px solid #E5E5E5', borderBottom: '1px solid #E5E5E5', padding: 'clamp(48px, 8vw, 64px) clamp(16px, 5vw, 24px)' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{ fontSize: 'clamp(24px, 6vw, 32px)', fontWeight: 700, letterSpacing: '-0.03em', color: '#0D0D0D', marginBottom: 10 }}>Coba sendiri, sekarang.</h2>
            <p style={{ fontSize: 14, color: '#6B7280', maxWidth: 440, margin: '0 auto', lineHeight: 1.6 }}>Kirim pesan ke inbox demo di bawah dan lihat Aira AI baca konteks & sarankan balasan terbaik.</p>
          </div>
          <LiveDemo />
        </div>
      </section>
      ...
      {/* FEATURES */}
      <section id="fitur" style={{ maxWidth: 1080, margin: '0 auto', padding: 'clamp(56px, 9vw, 80px) clamp(20px, 5vw, 24px)' }}>
        <div style={{ marginBottom: 48 }}>
          ...
          <h2 style={{ fontSize: 'clamp(26px, 6vw, 34px)', fontWeight: 700, letterSpacing: '-0.03em', color: '#0D0D0D', maxWidth: 480, lineHeight: 1.15 }}>Semua yang kamu butuhkan. Tidak lebih.</h2>
        </div>
        <div className="lp-features">
          {features.map((f) => (
            <div key={f.tag} style={{ background: '#fff', padding: 'clamp(22px, 5vw, 28px)' }}>
      ...
      <section style={{ background: '#F7F7F7', borderTop: '1px solid #E5E5E5', borderBottom: '1px solid #E5E5E5' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: 'clamp(56px, 9vw, 80px) clamp(20px, 5vw, 24px)' }}>
          <div className="lp-how">
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(26px, 6vw, 34px)', fontWeight: 700, letterSpacing: '-0.03em', color: '#0D0D0D', marginBottom: 36, lineHeight: 1.2 }}>Jalan dalam 10 menit.</h2>
              {[
            ...
            <div style={{ background: '#fff', border: '1px solid #E5E5E5', borderRadius: 12, padding: 'clamp(22px, 5vw, 32px)', display: 'flex', flexDirection: 'column', gap: 0 }}>
              {[
      ...
      {/* CTA */}
      <section style={{ background: '#0D0D0D', padding: 'clamp(56px, 9vw, 80px) clamp(20px, 5vw, 24px)', textAlign: 'center' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(26px, 7vw, 36px)', fontWeight: 700, letterSpacing: '-0.03em', color: '#fff', marginBottom: 14, lineHeight: 1.15 }}>
            Mulai hari ini.<br />
      ...
      <footer style={{ background: '#0D0D0D', borderTop: '1px solid #1F1F1F', padding: '20px clamp(20px, 5vw, 24px)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
